...
export default function LoginPage() {
    ...
    return (
        <div className="max-w-md mx-auto">
            <TerminalWindow title="user_login">
                <h2 className="text-2xl font-bold font-mono text-slate-200 mb-6">$ login</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <GlitchButton type="submit" disabled={isLoading} className="w-full">
                        {isLoading ? <Loader2 className="animate-spin" /> : <><LogIn size={16}/> Authenticate</>}
                    </GlitchButton>
                </form>
            </TerminalWindow>
        </div>
